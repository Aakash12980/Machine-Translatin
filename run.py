...
def train(**kwargs):
    ...
    tokenizer = SpaceTokenizer("./NMTtokenizers/spacetoken_vocab_files/vocab_newa.json", 
                "./NMTtokenizers/spacetoken_vocab_files/vocab_eng.json"
                    ...
                    "./NMTtokenizers/wordpiece_vocab_files/vocab_newa.json", 
                    "./NMTtokenizers/wordpiece_vocab_files/vocab_eng.json"
                )
    ...
    model  = Seq2Seq.trainer(model, optimizer, train_dl, valid_dl, BATCH_SIZE, epoch, 
...
@task.command()
@click.option('--src_file', default="./dataset/src_file.txt", help="Source file path")
@click.option('--output_file', default="./dataset/out.txt", help="Output file path")
@click.option('--best_model', default="./best_model/model.pt", help="best model file path")
@click.option('--tokenizer', default="space_tokenizer", help="space_tokenizer or bert_tokenizer")
def decode(**kwargs):
